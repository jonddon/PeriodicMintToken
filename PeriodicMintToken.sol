...
contract Esusu is Ownable,IERC20 {
    ...
    modifier timeElapse{
        require(_totalSupply<totalToMint, "Maximum reached");
        require((block.timestamp.sub(timeMintedLast)>= 20 seconds), "It's not one year yet");
        _;
    }
...
////////////////
    ...
    constructor() public {
        ...
        _symbol='ESS';
        _decimals=18;
    //   _totalSupply = 11111111111*(10**18);
